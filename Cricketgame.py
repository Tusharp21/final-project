...
# Form implementation generated from reading ui file 'Cricketgame.ui'
#
...
from Evaluatescore import QtGui

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1042, 810)
        ...
        self.actionSve_team = QtWidgets.QAction(MainWindow)
        self.actionSve_team.setObjectName("actionSve_team")
        ...
        self.menuManage_Teams.addAction(self.actionSve_team)
        self.menuManage_Teams.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "All Rounder (AR)"))
        ...
        self.actionSve_team.setText(_translate("MainWindow", "Open team"))
        self.actionSave_team.setText(_translate("MainWindow", "Save team"))
        self.actionEvaluate_team.setText(_translate("MainWindow", "Evaluate team"))

    def exit(self):                                                             #This function is Exit the program when exit button is Pressed
        import sys
        self.sd("Thanks! For Playing Come Back Soon...")
        sys.exit()

    def sd(self,msg):                                                           #This function is showing messages when required
        Dialog=QtWidgets.QMessageBox()
        Dialog.setText(msg)
        Dialog.setWindowTitle("Cricket Game")
        ret=Dialog.exec()
    ...
    def fillList(self,ctgr):                                                    #fills the list
    ...
    def removelist1(self,item):                                                 #This function is to remove players from list1 and add to the list2
        ctgr=''
        if self.radioButton.isChecked()==True:ctgr='AR'
        if self.radioButton_2.isChecked()==True:ctgr='WKT'
        if self.radioButton_3.isChecked()==True:ctgr='BWL'
        if self.radioButton_4.isChecked()==True:ctgr='BAT'
        ret=self.cr(ctgr,item)                                                  #check is adding player in list2 fulfills the condition or not
        if ret==True:                                                           
            self.listWidget.takeItem(self.listWidget.row(item))
            self.listWidget_2.addItem(item.text())
            self.show()                                                         #shows changes made in the program

    def removelist2(self,item):                                                 #This function is to remove players from list2 and add to the list1
        self.listWidget_2.takeItem(self.listWidget_2.row(item))
        cur=conn.execute("select player,value,ctg from stats where player='"+item.text()+"'") 
        row=cur.fetchone()
    ...
    def menu(self,action):                                                      #when menu button is pressed
        ...
        if txt == 'Evaluate team':                                              #when evaluate button is pressed
            from Evaluatescore import Ui_Form                                   
    ...
    def saveteam(self, name, ply, val):                                           #save team main funtion
        if self.bat + self.bwl + self.ar + self.wkt!= 0:                        #check total number of players
            self.sd("Insufficient players")
            return

        sql = "INSERT INTO teams (name,players,value) VALUES ('" + name + "','" + ply + "','" + str(val) + "');" 
        try:
            cur = conn.execute(sql)
