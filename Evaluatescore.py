...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(387, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Evaluate the Performance of Team"))
    ...
    def onChanged(self,text):                                                       #function when combobox1 item is clicked
            ...
            sql1 = "select players from teams where name='" + team1 + "'"           
    ...
    def evaluate(self): 
        ...
        for i in range(self.listView.count()-1):
            ...
            name=self.listView.item(i).text()                                   #name is initialised with player name according to the range
        ...
        self.lineEdit_8.setText(str(teamtotal))
